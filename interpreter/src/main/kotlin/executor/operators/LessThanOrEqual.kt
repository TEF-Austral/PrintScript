...
object LessThanOrEqual : Operator {
    ...
    override fun operate(
        ...
        if (numericResult != null) {
            ...
            return InterpreterResult(true, "Success LessThanOrEqual (Numeric)", resultVar)
        }
        ...
        if (stringResult != null) {
            ...
            return InterpreterResult(true, "Success LessThanOrEqual (String)", resultVar)
        }
    ...
    private fun compareAsBoolean(
        ...
        return if (leftBool != null && rightBool != null) {
            // Es verdadero si son iguales O si left es false.
